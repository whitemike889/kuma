...
# The root path (excluding the locale) of the add-on document pages.
ao_root = 'docs/Mozilla/Add-ons/'
# The root URL of the extension-workshop pages.
ew_root_url = 'https://extensionworkshop-dev.allizom.org/documentation/'
# The pairs are organized as tuples of (add-on path, extension-workshop path).
ew_pairs = [
...
webextensions_redirectpatterns = [
    external_redirect(
        ao_root + r'{}$'.format(ao_path),
        ew_root_url + ew_path
    ) for ao_path, ew_path in ew_pairs
]
